...
def _save_step_csv(path: Path, episode_summaries: List[Dict[str, object]]) -> None:
    fieldnames = [
        ...
        "obs_recent_events",
        "obs_market_demand",
        "obs_competition_level",
        "obs_economic_condition",
        "obs_pending_effects",
        "tech_action",
        "growth_action",
        "finance_action",
                ...
                writer.writerow(
                    {
                        ...
                        "obs_last_event": observation.get("last_event"),
                        "obs_recent_events": json.dumps(observation.get("recent_events", [])),
                        "obs_market_demand": observation.get("market_demand"),
                        "obs_competition_level": observation.get("competition_level"),
                        "obs_economic_condition": observation.get("economic_condition"),
                        "obs_pending_effects": json.dumps(observation.get("pending_effects", [])),
